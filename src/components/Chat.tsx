...
export function ChatWidget() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('open-kira-chat', handleOpenChat);
  }, []);
  ...
  // Submit private rating & review to the database
          ...
          {!selectedContact ? (
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50/50">
                ...
                {/* 1. Initial Trust Welcome Banner when history is clean */}
                {messages.length === 0 && (
                  <div className="p-4 bg-teal-50 border border-teal-100 rounded-2xl text-xs space-y-2 text-teal-800 shadow-sm">
                    ...
                    <p>📩 <strong>Chat Privado iniciado</strong> (Solo visible para ti y Carlos).</p>
                ...
                {messages.map((m) => {
                  ...
                  // Intercept Block: contact warning render
                  ...
                  // "Caja de Compra" / Session Offer render
                        ...
                        {isAccepted && (
                          <div className="space-y-2 pt-1">
                            ...
                            <div className="flex gap-2">
                              {/* Option to share secure contact info */}
                              <button 
                              ...
                              {/* Only coach or student can finalize */}
                              <button 
                  ...
                  if (m.type === 'session_review') {
                    ...
                    // Determine if the current user is the one who should write the review
                    // Alumno rates Coach
