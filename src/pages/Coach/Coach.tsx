...
type CoachTab = 'dashboard' | 'courses' | 'tracking' | 'nexus' | 'register' | 'automation' | 'profile' | 'analytics' | 'certificates' | 'books' | 'homework' | 'crm_audit' | 'support';
  ...
  return (
    <div className="flex flex-col gap-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-wrap gap-2 p-1.5 bg-slate-100 rounded-[32px] w-fit shadow-sm border border-slate-200/50">
        ...
        <TabBtn active={activeTab === 'courses'} onClick={() => handleTabChange('courses')} icon={<GraduationCap size={16}/>} label="Studio de Cursos" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white rounded-[40px] border border-slate-200 p-10 shadow-sm">
          <div className="flex justify-between items-center mb-10">
            ...
            <button onClick={() => setActiveTab('courses')} className="px-6 py-3 bg-slate-900 text-white rounded-2xl text-[12px] font-black uppercase tracking-widest shadow-xl hover:bg-black transition-all cursor-pointer">
              Studio de Cursos
            </button>
          </div>
